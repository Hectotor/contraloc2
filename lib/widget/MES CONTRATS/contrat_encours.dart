          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              final filteredContrats = contrats.where((contrat) {
                ...
                return clientName.contains(_searchController.text.toLowerCase()) ||
                    dateDebut.toString().contains(_searchController.text.toLowerCase()) ||
                    immatriculation.contains(_searchController.text.toLowerCase());
              }).toList();
