...
import 'pdf_commentaire.dart';
import 'package:contraloc/MOBILE/USERS/contrat_condition.dart';
      ...
      build: (pw.Context context) => [
        pw.Column(
          ...
          children: [
            ...
            pw.SizedBox(height: 10),
            // Utilisation du module pdf_commentaire.dart pour générer la section des commentaires
            buildCommentairesSection(
              contratModel: contratModel,
              boldFont: boldFont,
              ttf: ttf,
            ),
