...
class _AddVehiculeScreenState extends State<AddVehiculeScreen> {
  ...
  Future<Map<String, dynamic>> _prepareVehicleData() async {
    ...
    return {
      ...
      'prixLocation': double.tryParse(_prixLocationController.text) ?? 0.0,
      'franchise': double.tryParse(_franchiseController.text) ?? 0.0,
      'kilometrageSupp': double.tryParse(_kilometrageSuppController.text) ?? 0.0,
      'rayures': double.tryParse(_rayuresController.text) ?? 0.0,
