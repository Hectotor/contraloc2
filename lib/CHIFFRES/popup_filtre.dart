          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildFilterCheckbox('Frais carburant manquant', 'factureFraisCarburantManquant', setState),
                _buildFilterCheckbox('Frais rayures/dommages', 'factureFraisRayuresDommages', setState),
                _buildFilterCheckbox('Frais autres', 'factureFraisAutre', setState),
                _buildFilterCheckbox('Caution', 'factureCaution', setState),
              ],
            ),
          );
        },
