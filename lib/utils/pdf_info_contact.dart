      ...
      child: pw.Column(
        ...
        children: [
          ...
          if (adresse.isNotEmpty)
            pw.Text('Adresse: $adresse', style: pw.TextStyle(font: ttf)),
          pw.SizedBox(height: 5),
          if (telephone.isNotEmpty)
            pw.Text('Téléphone: $telephone', style: pw.TextStyle(font: ttf)),
          pw.SizedBox(height: 5),
          pw.Text('SIRET: $siret', style: pw.TextStyle(font: ttf)),
        ],
      ),
    );
  }
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Divider(color: PdfColors.black),
          pw.Text('Nom: ${clientData['nom']}', style: pw.TextStyle(font: ttf)),
